"""
Example script for fine-tuning a model with LoRA.

This script demonstrates how to use the LoRA parameter-efficient fine-tuning method
...
def main():
    ...
    config_path = "./configs/lora_config.json"
    ...
    print(f"Model fine-tuned with LoRA and saved to {args.output_dir}")
